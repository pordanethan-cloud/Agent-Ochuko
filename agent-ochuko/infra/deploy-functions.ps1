...
Write-Host "     az rest --method post \"
Write-Host "       --url https://management.azure.com/subscriptions/{sub}/resourceGroups/$ResourceGroup/providers/Microsoft.Web/sites/$FunctionAppName/functions/{functionName}/listKeys?api-version=2022-03-01"
Write-Host ""
