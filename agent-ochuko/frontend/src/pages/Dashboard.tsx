  ...
  return (
    <div className="group relative bg-[#0b0c0e] border border-[#1a1d20]/80 rounded-xl overflow-hidden my-4 shadow-lg">
      ...
      <div ref={menuRef} className="absolute top-2 right-2 z-20 flex items-center opacity-0 group-hover:opacity-100 transition-opacity duration-150">
        ...
        <button
          onClick={handleCopy}
          className="flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-medium rounded-l-md border border-r-0 border-[#30363d] bg-[#161b22] text-[#8b949e] hover:text-[#c9d1d9] hover:bg-[#21262d] transition-colors select-none"
        >
          {copied ? (
            <>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center justify-center px-1.5 py-1 h-8 rounded-r-md border border-[#30363d] bg-[#161b22] text-[#8b949e] hover:text-[#c9d1d9] hover:bg-[#21262d] transition-colors"
          >
