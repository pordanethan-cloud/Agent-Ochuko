 ...
 * 3. AuthCallback (in App.tsx) reads the session and checks role.
 * 4. Non-admins are redirected to /not-authorized.
 * 5. Admins land on /users.
 */
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-400 text-sm mt-1">Agent Ochuko Control Plane</p>
          </div>
