...
BASE_IDENTITY = (
    ...
    "Match response length to question complexity. Greetings get 1-2 sentences; simple queries get 2-4 sentences; "
    "multi-part analyses get 3-5 focused paragraphs. Never pad short answers or truncate complex ones. "
    "Responses must fit the question.\n\n"
